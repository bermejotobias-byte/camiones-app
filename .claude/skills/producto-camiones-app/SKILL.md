...
| 🔨 💬 | **Lugares de interés valorados por usuarios**, que además confirmen si son aptos para tránsito pesado (y eso da puntos). **La base se relevó el 15/09/2026**: 158 POIs, 26 con aptitud declarada por evidencia (registro oficial, operador, reseñas de conductores con fecha) — 16 gomerías, 5 estaciones, 1 lugar para comer, más 66 estaciones sobre la Red sin confirmar. **Falta la interfaz** (la app web no muestra POIs) y sigue pendiente la conversación sobre la valoración por usuarios (L-6) | v2 · 15/09/2026 |
...
| Aptitud de POIs | 🔨 **Relevada el 15/09/2026** con tres vías de evidencia: registro oficial, operador y reseñas de conductores (que cuentan como confirmación, con fecha). 26 de 158 con aptitud declarada. Google Maps pasó a ser referencia de descubrimiento y verificación para los POIs, nunca base que se copia. El v2 propone que los usuarios completen el resto: eso es un dato de comunidad, **no oficial**, y tiene que verse distinto |
