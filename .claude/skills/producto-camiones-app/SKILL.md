...
| Aptitud de POIs | 🔨 **Relevada el 15/09/2026** con tres vías de evidencia: registro oficial, operador y reseñas de conductores (que cuentan como confirmación, con fecha). 48 de 180 con aptitud declarada. Google Maps pasó a ser referencia de descubrimiento y verificación para los POIs, nunca base que se copia. **Y desde ese día los usuarios completan el resto** (AD-46): votan con su tipo de camión y agregan lugares. Es un dato de comunidad, **no oficial**, y se ve distinto: sello aparte, nunca toca el nivel verificado, y el filtro "solo aptos" lo usa sólo donde la fuente no dice nada |
