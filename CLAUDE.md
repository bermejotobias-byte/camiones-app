...
node --test "tests/web/*.test.mjs"             # 130 tests: guiado, avisos de ruta, piezas, pantalla del viaje (banda, hoja, globos, aviso, vista general), tarjetas de ruta, busqueda, flecha de maniobra, agenda, mascota e insignias
