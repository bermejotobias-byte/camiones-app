...
node --test "tests/web/*.test.mjs"             # 124 tests: guiado, avisos de ruta, piezas, pantalla del viaje (banda, hoja, globos, aviso, vista general), tarjetas de ruta, flecha de maniobra, agenda, mascota e insignias
