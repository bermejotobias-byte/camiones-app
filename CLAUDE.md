...
node --test "tests/web/*.test.mjs"             # 153 tests: guiado, avisos de ruta, piezas, pantalla del viaje (banda, hoja, globos, aviso, vista general), tarjetas, lista y detalles de ruta, busqueda, flecha de maniobra, agenda, mascota e insignias
