...
node --test "tests/web/*.test.mjs"             # 161 tests: guiado, avisos de ruta, piezas, pantalla del viaje (banda, hoja, globos, aviso, vista general), tarjetas, lista y detalles de ruta, busqueda, capa de lugares, flecha de maniobra, agenda, mascota e insignias
