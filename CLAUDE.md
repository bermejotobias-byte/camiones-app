...
node --test "tests/web/*.test.mjs"             # 112 tests: guiado, avisos de ruta, piezas, pantalla del viaje (banda, hoja, globos, tarjeta de aviso), flecha de maniobra, agenda, mascota e insignias
