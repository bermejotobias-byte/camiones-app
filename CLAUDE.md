...
node --test "tests/web/*.test.mjs"             # 138 tests: guiado, avisos de ruta, piezas, pantalla del viaje (banda, hoja, globos, aviso, vista general), tarjetas y lista de rutas, busqueda, flecha de maniobra, agenda, mascota e insignias
