...
| Día | **Derivado, no medido**: no hay captura de Waze de día (pedida al usuario el 18/09/2026). Banda y hojas blancas con tinta oscura, el celeste oscurecido para el contraste, la fila elegida en gris claro `#eef1f4`; el mapa con calles blancas y filete gris, la Red en azul acero claro y la autopista en amarillo pálido. Los tokens de día están en `app.css` (`:root[data-theme="light"]`) y se revisan contra la captura cuando llegue |
